...
package_name = 'robo_desviante_spawner_pkg'
...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name,'models/labirinto/'), glob('./models/labirinto/*')),

        # Path to the mobile robot sdf file
        (os.path.join('share', package_name,'models/robo_desviante/'), glob('./models/robo_desviante/*')),
    ...
    entry_points={
        'console_scripts': [
          'spawn_demo = robo_desviante_spawner_pkg.spawn_demo:main'
        ],
    },
)