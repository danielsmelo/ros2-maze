...
class Controller(Node):
  ...
  def __init__(self):
    ...
    self.turning_speed_wf_slow = 0.048 # Slow turn

    # Wall following distance threshold.
    # We want to try to keep within this distance from the wall.
    self.dist_thresh_wf = 1.20 # in meters
  ...
  def follow_wall(self):
    ...
    c = self.dist_too_close_to_wall
    s = 0

    if self.leftfront_dist < c or self.front_dist < c or self.rightfront_dist < c: #tem parede em todos os lados
      s = 1

      if self.leftfront_dist > d and self.front_dist < d and self.rightfront_dist > d: #só tem parede na frente
        msg.angular.z = self.turning_speed_wf_fast

      elif self.leftfront_dist > d and self.front_dist > d and self.rightfront_dist < d: #só tem parede na direita
        msg.angular.z = self.turning_speed_wf_fast

      elif self.leftfront_dist < d and self.front_dist > d and self.rightfront_dist > d: #só tem parede na esquerda
        msg.angular.z = -self.turning_speed_wf_fast

      elif self.leftfront_dist > d and self.front_dist < d and self.rightfront_dist < d: #tem parede na frente e na direita
        msg.angular.z = self.turning_speed_wf_fast

      elif self.leftfront_dist < d and self.front_dist < d and self.rightfront_dist > d: #tem parede na frente e na esquerda
        msg.angular.z = -self.turning_speed_wf_fast

      elif self.leftfront_dist < d and self.front_dist < d and self.rightfront_dist < d: #tem parede na frente e na esquerda e na direita
      ...
      elif self.leftfront_dist < d and self.front_dist > d and self.rightfront_dist < d: #tem parede na esquerda e na direita
    ...
    if s == 0:
      ...
      if self.leftfront_dist > d and self.front_dist > d and self.rightfront_dist > d: #nada no laser
        msg.linear.x = self.forward_speed
        msg.angular.z = -self.turning_speed_wf_slow

      elif self.leftfront_dist > d and self.front_dist < d and self.rightfront_dist > d: #só tem parede na frente
